...
async function initDashboardStats() {
    ...
    // 2. Estadísticas de Medicina (Admin)
    if (document.getElementById('stat-medicina-total')) {
        await cargarStatsMedicinaAdmin();
    }
}
...
/**
 * Carga las estadísticas del módulo de Medicina (Admin)
 */
async function cargarStatsMedicinaAdmin() {
    try {
