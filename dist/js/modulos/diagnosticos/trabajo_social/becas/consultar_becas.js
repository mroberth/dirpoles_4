/**
 * Gestión de consulta de Becas
 * Maneja los eventos de Ver, Editar y Eliminar para el módulo de Becas
 */
...
function asignarEventosBotones() {
    ...
    $(document).on('click', '.btn-ver', function () {
        ...
        // Solo ejecutar si es del tipo 'becas'
        if (tipo === 'becas') {
            verBeca(id, tipo);
        }
    });
 ...
 */
function eliminarBeca(id, idSolicitud) {
    Swal.fire({
        title: '¿Estás seguro?',
        text: "Esta acción eliminará la beca y su solicitud de servicio asociada",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            fetch('beca_eliminar', {
                ...
                body: `id_becas=${id}&id_solicitud_serv=${idSolicitud}`
            })
                ...
                .catch(error => {
                    ...
                    AlertManager.error('Error de conexión', 'No se pudo eliminar la beca');
                });
